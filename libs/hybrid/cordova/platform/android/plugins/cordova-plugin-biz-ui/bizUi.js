 ...
 */
 module.exports = {
     ...
     */
    openOrderList: function(successCallback,errorCallback,content) {
    ...
    openCustomerFeedbackList: function(successCallback,errorCallback,content) {
        exec(successCallback, errorCallback, "BizUiPlugin", "openCustomerFeedbackList", []);
    },
    openSystemFeedbackList: function(successCallback,errorCallback,content) {
    ...
    ,
    openScanOutStorage: function(successCallback,errorCallback,content) {
        exec(successCallback, errorCallback, "BizUiPlugin", "openScanOutStorage", []);
    }
    ,
    openSendOutVerification: function(successCallback,errorCallback,content) {
        exec(successCallback, errorCallback, "BizUiPlugin", "openSendOutVerification", []);
    }
};
});