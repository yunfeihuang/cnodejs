 ...
 */
 module.exports = {
    ...
    changeAccount:function(successCallback,errorCallback,content){
        exec(successCallback, errorCallback, "BizPlugin", "changeAccount", []);
    },
    logout:function(successCallback,errorCallback,content){
    ...
    grade:function(successCallback,errorCallback,content){
